...
// ABOUTME: Updates every second via setInterval; onToggleFormat enables inline 12h/24h toggle without opening SettingsPanel
...
export function Clock({ use12h = false, accent, onToggleFormat }: ClockProps) {
  ...
  return (
    <div style={{ marginBottom: 20 }}>
      ...
      {/* Date row: date string + inline format toggle button (shows current format; click to switch) */}
