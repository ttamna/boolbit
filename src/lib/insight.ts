...
export function calcTodayInsight(params: InsightParams): TodayInsight | null {
  ...
  // Fires AFTER habit_pomodoro_dual_win (3.95): the combined cross-domain achievement takes precedence.
