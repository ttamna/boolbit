...
export function calcTodayInsight(params: InsightParams): TodayInsight | null {
  ...
  // Fires BEFORE goal_done (10.7): data-driven intention insight outranks a passive "goal already done" status.
