...
export function calcTodayInsight(params: InsightParams): TodayInsight | null {
  ...
  // Fires AFTER habit_week_declined (10.37): a week-long habit regression is a more persistent signal.
