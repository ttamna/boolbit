...
export function calcTodayInsight(params: InsightParams): TodayInsight | null {
  ...
  // Fires AFTER momentum_month_strong (10.44): a month of sustained high-tier momentum > a single-day pomodoro spike.
