...
interface InsightParams {
   ...
   * When this value is exactly 7 (goal met every day): "pomodoro_week_goal_perfect" success badge
   * fires at priority 10.3821 — before pomodoro_week_improved (10.383).
   * Absent/undefined = sessionGoal not set or not computed; badge skipped silently.
   */
...
export function calcTodayInsight(params: InsightParams): TodayInsight | null {
  ...
  // Fires AFTER pomodoro_week_goal_perfect (10.3821): absolute achievement checked before comparative delta.
