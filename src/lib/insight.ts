...
export function calcTodayInsight(params: InsightParams): TodayInsight | null {
  ...
  // Fires BEFORE momentum_month_strong (10.44): month-long intention execution outranks momentum aggregate.
