...
interface InsightParams {
   ...
   *   and momentum_week_excellent (10.3801) returns first when momentumWeekAvg7d ∈ [50, 65),
   *   so both comparison blocks are only reached when the current avg is below 50.
