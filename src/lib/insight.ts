...
export function calcTodayInsight(params: InsightParams): TodayInsight | null {
  ...
  // Fires AFTER pomodoro_week_goal_excellent (10.3822): absolute goal achievement checked before comparative delta.
