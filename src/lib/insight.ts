...
export function calcTodayInsight(params: InsightParams): TodayInsight | null {
  ...
  // Fires AFTER momentum_month_strong (10.44): a month of sustained momentum > a 14-day pomodoro run.
