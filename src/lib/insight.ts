...
export function calcTodayInsight(params: InsightParams): TodayInsight | null {
  ...
  // Fires AFTER pomodoro_month_goal_excellent (10.442): sustained 14-day consistency > single-day spike.
