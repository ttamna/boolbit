...
export function calcTodayInsight(params: InsightParams): TodayInsight | null {
  ...
  // Fires AFTER habit_month_excellent (10.41): month-long habit attendance outranks intention perfection.
