...
export function calcTodayInsight(params: InsightParams): TodayInsight | null {
  ...
  // Interaction with momentum_streak_milestone (10.45): when momentumStreak ∈ [7, 14, 30] AND
  //   todayMomentumQualifies, the milestone fires first at priority 10.45. Examples:
