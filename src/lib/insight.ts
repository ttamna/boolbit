...
export function calcTodayInsight(params: InsightParams): TodayInsight | null {
  ...
  // Fires AFTER momentum_week_declined (10.382): a week-long regression takes priority over a single-day bounce.
