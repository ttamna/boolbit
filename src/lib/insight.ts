...
export function calcTodayInsight(params: InsightParams): TodayInsight | null {
  ...
  // Fires AFTER momentum_week_declined (10.382): week-level momentum aggregate checked before pomodoro session count.
