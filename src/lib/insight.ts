...
export function calcTodayInsight(params: InsightParams): TodayInsight | null {
  ...
  // Fires BEFORE pomodoro_today_above_avg (10.45): month-long intention consistency outweighs a single-day pomodoro spike.
