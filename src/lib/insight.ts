...
export function calcTodayInsight(params: InsightParams): TodayInsight | null {
  ...
  // Fires before habit_diversity_warning (10.22): a total absence preempts relative imbalance.
